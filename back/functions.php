 ...
 * 
 */
function photoUpdate(int $itemId): bool
{
    $oldPicsName = getNameById($itemId);
...
//____________________Additional functions___________________________//
